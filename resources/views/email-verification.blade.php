    ...
    <table style="width:100%;max-width:500px;margin:0 auto;text-align:center;background:#fff">
        <tr>
            <td style="padding:30px 30px 0">
                ...
                <h3 style="font-size:17px;font-weight:500">Email Verification</h3>
            </td>
        </tr>
        <tr>
            <td style="padding:0 30px 30px; text-align:left">
                <span style="display:block;margin-bottom:14px">Your Verification Code is</span>
                <h2 style="font-size: 26px;margin: 0;letter-spacing:4px;text-align:center">{{$token ?? '12345'}}</h2>
                <br>
